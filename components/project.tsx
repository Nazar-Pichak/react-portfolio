...
export default function Project(props: ProjectProps) {
    ...
    return (
        <motion.div ref={ref} className="group mb-3 sm:mb-8 last:mb-0" style={{scale: scaleProgress, opacity: opacityProgress}}>
            <section className="bg-gray-100 relative max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
                <div className="flex flex-col h-full pt-4 pb-7 px-5 sm:pl-10 sm-pr-2 sm:pt-10 sm:max-w-1/2 sm:group-even:ml-[18rem]">
                ...
                <Image src={imageUrl}
                    className="absolute hidden sm:block top-8 -right-40 w-[28.25rem]
                        ...
                        group-even:-left-40
                        transition"
                    alt="Project i worked on" quality={95}/>
            </section>
        </motion.div>
    );
}